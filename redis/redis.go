...
func InitRedisPool(host, password string, database, maxOpenConn, maxIdleConn int) *ConnPool {
	r := &ConnPool{}
	r.redisPool = newPool(host, password, database, maxOpenConn, maxIdleConn)
